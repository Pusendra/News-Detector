kw = ['RAVI','LAMICCHANE','rabi','RABi','NEWS 24','News 24','News24', 'Sidhakura Online','sidhakura online','SidhakuraOnline','Sidhakura ', 'Rabi', 'lamicchane', 'Rabi Lamicchane', 'Arrested', 'chitwan', 'Rabi Lamichhane', 'death', 'Gyanendra Shahi', 'News24 Nepal','NEWS24 TV','News24 Nepal','Salikram Pudasaini', 'Salikram', 'Pudasaini']
tags = "SPANEMBIULOLI";
total = 0;
...
function hideNode(node) {
	node.textContent = '[TEXT BLOCKED: RABI LAMICCHANE NEWS DETECTED]';
